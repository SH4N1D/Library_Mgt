...
public class custom_libbooks_new extends BaseAdapter {
...
//    ArrayList<String> i;
    ...
    public custom_libbooks_new(Context applicationContext, ArrayList<String> a, ArrayList<String> b, ArrayList<String> c, ArrayList<String> d, ArrayList<String> e, ArrayList<String> f) {
...
//        this.i=i;
    ...
    public View getView(int position, View convertview, ViewGroup parent) {
        ...
        if(convertview==null)
        {
            ...
            gridView=inflator.inflate(R.layout.activity_custom_libbooks_new, null);
        ...
        TextView tv3=(TextView)gridView.findViewById(R.id.au);
        TextView tv4=(TextView)gridView.findViewById(R.id.ca);
        TextView tv5=(TextView)gridView.findViewById(R.id.ty);
...
//        TextView tv8=(TextView)gridView.findViewById(R.id.ty);
        ...
        b1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if("View Ebook".equals(b1.getText().toString()))
                {
                    String url="http://"+sh.getString("ip","")+":5000/media/"+f.get(position)+".pdf";
                    ...
                    Intent ii =new Intent(context,placeorder_new.class);
                    ii.putExtra("bid",f.get(position));
