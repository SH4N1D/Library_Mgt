		...
		{
				{
					...
					{
						edtxttosent.setError("Enter The Message");
					}
					else {
						SharedPreferences sh = PreferenceManager.getDefaultSharedPreferences(getApplicationContext());
						...
						String url = "http://" + ip + ":5000/lib_insert_chat";
...
//		                    Toast.makeText(getApplicationContext(),response,Toast.LENGTH_SHORT).show();
										...
										try {
											...
											Toast.makeText(Test.this, "=====" + e, Toast.LENGTH_SHORT).show();
										}
									}
								},
							...
							protected Map<String, String> getParams() {
								...
								String toid = getIntent().getStringExtra("uid");
			                            ...
			                            if(sucs.equalsIgnoreCase("ok"))
			                            {
			                            	...
			                            	for(int i=0;i<jsa.length();i++)
			                            	{
			                            		...
			                            		if(!fid[i].equalsIgnoreCase(sh.getString("lid","")))
			    					    		{
													...
													message1.setUsername(getIntent().getStringExtra("na"));
...
//			                        Toast.makeText(getApplicationContext(),"eeeee"+error.toString(),Toast.LENGTH_SHORT).show();
			            ...
			            protected Map<String, String> getParams()
			            {
			              ...
			              String s=sh.getString("lid","");
			                params.put("fid", s);
			                params.put("toid",  getIntent().getStringExtra("uid"));
