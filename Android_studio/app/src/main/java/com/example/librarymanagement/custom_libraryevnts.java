...
public class custom_libraryevnts extends BaseAdapter {
    private Context context;
    ArrayList<String> a;


    SharedPreferences sh;
    public custom_libraryevnts(Context applicationContext, ArrayList<String> a) {
    ...
    public View getView(int position, View convertview, ViewGroup parent) {
        ...
        if(convertview==null)
        {
            ...
            gridView=inflator.inflate(R.layout.activity_custom_libraryevnts, null);
