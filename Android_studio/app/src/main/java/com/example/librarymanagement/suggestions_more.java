...
public class suggestions_more extends ListeningActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_suggestions_more);

        li=findViewById(R.id.sl);
        sh= PreferenceManager.getDefaultSharedPreferences(getApplicationContext());

        SharedPreferences.Editor edp = sh.edit();
        edp.putString("sid", getIntent().getStringExtra("sid"));
        edp.commit();

        url ="http://"+sh.getString("ip", "") + ":5000/view_suggestbk_more";
        RequestQueue queue = Volley.newRequestQueue(suggestions_more.this);
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.POST, url,new Response.Listener<String>() {
            ...
            public void onResponse(String response) {
                ...
                try {
                    ...
                    li.setAdapter(new custom_suggestions_more(suggestions_more.this,im,un,bn,da,st,de,au,re,ca,sid));
//                    l1.setOnItemClickListener(suggestions.this);
            ...
            public void onErrorResponse(VolleyError error) {
                ...
                Toast.makeText(suggestions_more.this, "err"+error, Toast.LENGTH_SHORT).show();
            }
        }) {
            @Override
